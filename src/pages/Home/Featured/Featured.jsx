...
function Featured() {
  return (
    <div className="featured-item bg-fixed text-white pt-8 my-20">
     ...
     ></SectionTitle>
      <div className="lg:flex justify-center bg-slate-500 bg-opacity-60 items-center pb-20 pt-12 px-36 ">
        <div>
        ...
        <div className="lg:ml-10">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                ...
                Fuga perferendis facere itaque ad quisquam dicta unde dolore,
                 ...
                 <Link to='/menu'><button className="btn text-white btn-outline border-0 border-b-4 mt-4">Order Now</button></Link>
        </div>
      </div>
    </div>
  )
